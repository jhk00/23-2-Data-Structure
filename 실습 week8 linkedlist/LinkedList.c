...
int main(void) {
    ...
    insert_node(&head1, search(head1, 10), create_node(30)); // head1의 20노드 다음에 30노드를 insert
    display(head1); // head1 display
    remove_node(&head1, search(head1, 20), search(head1, 30)); // head1의 20노드의 다음의 30노드를 remove
    display(head1); // head1 display
